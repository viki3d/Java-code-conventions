...
public interface NumbersApi {
  ...
  /**
   * Calculates squares of all numbers in interval [0, number].
   *
  ...
  /**
   * Finds all odd numbers in interval [0, number].
   *
   * @param number Path {@code int} parameter; The upper boundary of the interval [0, number].
   * 
  ...
  /**
   * Finds the sum of all numbers numbers in interval [0, number].
   *
   * @param number Path {@code int} parameter; The upper boundary of the interval [0, number].
   * 
